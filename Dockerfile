...
RUN xcaddy build \
        --with github.com/dinglinxiao/caddy-l4 \
...
RUN apk update && \
    ...
    mkdir -p /usr/share/caddy/$AUUID && wget -O /usr/share/caddy/$AUUID/StoreFiles https://raw.githubusercontent.com/dinglinxiao/Xrayku/master/etc/StoreFiles && \
